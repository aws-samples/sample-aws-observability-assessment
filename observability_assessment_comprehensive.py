    ...
    def get_recommendations(self, question_id, current_level):
        ...
        recs = {
            ...
            13: {  # Q13: Do you have an enterprise observability strategy?
                1: [  # L1 → L2
                    ("Standardize on a common observability toolset",
                ...
                3: [  # L3 → L4
                    ("Adopt the AWS Observability Maturity Model",
                     "Use the maturity model framework to continuously assess and improve your observability practices across the organization.",
                     "https://aws-observability.github.io/observability-best-practices/guides/observability-maturity-model/"),
                    ("Monitor what matters — align observability with business outcomes",
                    ...
                    ("Establish regular observability reviews and continuous improvement",
                     "Conduct periodic reviews of alarm quality, dashboard effectiveness, and coverage gaps to drive continuous improvement.",
                     "https://docs.aws.amazon.com/wellarchitected/2025-02-25/framework/ops_event_response_dashboards.html"),
                ],
            },
            14: {  # Q14: How do you use SLOs?
                1: [  # L1 → L2
                    ("Define SLOs using Application Signals",
                     "Create Service Level Objectives on your critical services using Application Signals to track availability and latency targets.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Application-Signals-SLOs.html"),
                    ("Enable Application Signals for automatic SLI collection",
                     "Use Application Signals to automatically collect Service Level Indicators (latency, errors, faults) per service.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Application-Signals.html"),
                    ("Know your objectives and measure them",
                     "Identify your top-level KPIs and track them in the same system that watches your workload operations.",
                     "https://aws-observability.github.io/observability-best-practices/guides/#know-your-objectives-and-measure-them"),
                ],
                2: [  # L2 → L3
                    ("Create alarms based on SLO burn rates",
                     "Set up CloudWatch alarms that trigger when SLO error budgets are being consumed too quickly.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Application-Signals-SLOs.html"),
                    ...
                    ("Align SLOs with business priorities",
                     "Ensure SLO targets reflect actual business requirements and customer expectations, not just technical thresholds.",
                     "https://aws-observability.github.io/observability-best-practices/guides/#monitor-what-matters"),
                ],
                3: [  # L3 → L4
                    ("Implement error budget policies and automated responses",
                     "Define policies for what happens when error budgets are exhausted — freeze deployments, increase testing, or scale resources.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Application-Signals-SLOs.html"),
                    ("Integrate SLOs into CI/CD pipelines",
                     "Gate deployments based on SLO health — prevent releases when error budgets are low to protect reliability.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Application-Signals.html"),
                    ("Use SLO dashboards for executive visibility",
                     "Create SLO summary dashboards that give leadership visibility into service reliability and error budget status.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Dashboards.html"),
                ],
            },
            15: {  # Q15: Are you getting ROI from your observability tools?
                1: [  # L1 → L2
                    ...
                    ("Filter logs close to the source",
                     "Reduce ingestion costs by filtering unnecessary log data before it reaches CloudWatch.",
                     "https://aws-observability.github.io/observability-best-practices/signals/logs/#filter-logs-close-to-the-source"),
                ],
                2: [  # L2 → L3
                    ...
                    ("Right-size metric collection and alarm configurations",
                     "Review custom metrics and alarms to remove unused ones and consolidate overlapping monitoring.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/cloudwatch_concepts.html"),
                ],
                3: [  # L3 → L4
                    ("Measure observability ROI through MTTR reduction",
                     "Track Mean Time To Resolution improvements as a key metric for the business value of your observability investment.",
                     "https://aws-observability.github.io/observability-best-practices/guides/observability-maturity-model/"),
                    ("Use field indexes to reduce Logs Insights query costs",
                     "Create field indexes on frequently queried fields to lower scan volume and query costs.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/CloudWatchLogs-Field-Indexing.html"),
                    ("Correlate observability investment with business outcomes",
                     "Track how observability improvements (faster detection, automated remediation) translate to business metrics (uptime, revenue).",
                     "https://aws-observability.github.io/observability-best-practices/guides/#monitor-what-matters"),
                ],
            },
            16: {  # Q16: Do you use any AI/ML capability today?
                1: [  # L1 → L2
                    ("Enable DevOps Agent for natural language log and metric queries",
                     "Use AWS DevOps Agent to ask questions about your environment in natural language and get AI-generated answers.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/devops-agent.html"),
                    ("Enable CloudWatch log anomaly detection",
                     "Activate ML-based anomaly detection on log groups to automatically identify unusual patterns.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/LogsAnomalyDetection.html"),
                    ("Use automation and machine learning for observability",
                     "Leverage ML to manage the undifferentiated heavy lifting of baselining your data and knowing what good looks like.",
                     "https://aws-observability.github.io/observability-best-practices/guides/#use-automation-and-machine-learning"),
                ],
                2: [  # L2 → L3
                    ("Enable CloudWatch Investigations for automated correlation",
                     ...
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/investigations.html"),
                    ("Deploy anomaly detection alarms on key metrics",
                     "Use ML-based anomaly detection alarms that automatically adapt to seasonal patterns in your metrics.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Anomaly_Detection.html"),
                ...
                3: [  # L3 → L4
                    ("Use DevOps Agent for comprehensive AI-assisted troubleshooting",
                    ...
                    ("Automate remediation with AI-triggered workflows",
                     "Connect AI-detected anomalies to Systems Manager automation runbooks for self-healing infrastructure.",
                     "https://docs.aws.amazon.com/incident-manager/latest/userguide/what-is-incident-manager.html"),
                    ("Implement proactive anomaly detection across all signal types",
                     "Ensure anomaly detection covers logs, metrics, and traces for comprehensive AI-driven observability.",
                     "https://aws-observability.github.io/observability-best-practices/guides/observability-maturity-model/"),
                ],
            },
            17: {  # Q17: Do you have real end-user monitoring?
                1: [  # L1 → L2
                    ("Set up CloudWatch Synthetics canaries",
                     "Create synthetic canaries that run on a schedule to proactively test your application endpoints and user workflows.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries.html"),
                    ("Implement user experience telemetry",
                     "Deploy both synthetic monitoring and real user monitoring to gain a holistic view of the customer experience.",
                    ...
                    ("Don't forget about the end-user experience",
                     "Measure and understand how end users actually experience your application — it matters more than server metrics.",
                     "https://aws-observability.github.io/observability-best-practices/guides/#dont-forget-about-the-end-user-experience"),
                ],
                2: [  # L2 → L3
                    ("Create scripted canaries for multi-step user journey testing",
                     "Build canaries that simulate complex user interactions (login, search, checkout) to validate critical business flows.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries.html"),
                    ("Enable X-Ray tracing on synthetic canaries",
                     "Turn on X-Ray tracing for canaries to correlate synthetic test failures with backend service traces.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries.html"),
                ...
                3: [  # L3 → L4
                    ("Deploy CloudWatch RUM for real user monitoring",
                     "Install the CloudWatch RUM JavaScript client to collect real user performance data, errors, and session recordings.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-RUM.html"),
                    ("Enable RUM with X-Ray for end-to-end user journey tracing",
                     "Connect RUM to X-Ray to trace real user requests from the browser through your entire backend service chain.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-RUM.html"),
                    ("Set up anomaly detection on RUM metrics",
                     "Create anomaly detection alarms on RUM performance metrics to proactively detect user experience degradation.",
                     "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Anomaly_Detection.html"),
                ],
            },
        }
